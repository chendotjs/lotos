...
extern int lotos_epoll_add(int epoll_fd, connection_t *restrict pconn,
                           uint32_t events, struct epoll_event *pev);
extern int lotos_epoll_mod(int epoll_fd, connection_t *restrict pconn,
                           uint32_t events, struct epoll_event *pev);
extern int lotos_epoll_del(int epoll_fd, connection_t *restrict pconn,
                           uint32_t events, struct epoll_event *pev);
